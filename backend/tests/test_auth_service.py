...
async def test_auth_service_sign_in_success(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("SHARELEDGER_SUPABASE_SERVER_KEY", "dummy-server-key")
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        assert request.headers["apikey"] == "dummy-server-key"
        assert request.headers["authorization"] == "Bearer dummy-server-key"
